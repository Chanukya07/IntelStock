...
STOCKS = {
    "RELIANCE": {"name":"Reliance Industries","price":2987,"chg":2.4,"pe":24.3,"pb":2.1,"mktcap":"₹20.2L Cr","div":0.8,"roe":13.2,"sentiment":"Bullish","score":82,
                 "ai":"Reliance Industries is showing strong bullish momentum. Q4 FY26 results beat estimates with Jio revenue up 12% YoY and retail segment delivering record margins. The stock is trading near its 52-week high. Key support at ₹2,880, resistance at ₹3,050. FII ownership increased 0.4% this quarter. Recommendation: Hold / Accumulate on dips."},
    "TCS":      {"name":"Tata Consultancy","price":4124,"chg":1.8,"pe":31.2,"pb":12.4,"mktcap":"₹14.9L Cr","div":1.2,"roe":47.8,"sentiment":"Bullish","score":78,
                 "ai":"TCS continues to outperform the IT index. US deal pipeline commentary for Q1 FY27 is positive with large deal wins of $2.4B. The company's AI-focused service offering is gaining traction. Key levels: support ₹3,980, resistance ₹4,280. Recommendation: Buy on dips."},
    "HDFC":     {"name":"HDFC Bank","price":1680,"chg":-0.9,"pe":19.1,"pb":2.8,"mktcap":"₹12.7L Cr","div":1.6,"roe":15.4,"sentiment":"Neutral","score":54,
                 "ai":"HDFC Bank is facing near-term headwinds post merger integration. NIM compression continues but credit growth remains healthy at 14% YoY. The stock is consolidating in the ₹1,600-1,750 range. Recommendation: Neutral — wait for NIM stabilization."},
    "INFY":     {"name":"Infosys","price":1925,"chg":3.1,"pe":27.4,"pb":8.9,"mktcap":"₹7.9L Cr","div":2.1,"roe":32.6,"sentiment":"Bullish","score":75,
                 "ai":"Infosys raised FY27 revenue guidance to 4-7% in CC terms, beating analyst expectations. Cost efficiency programs are improving margins. The stock broke out of a 3-month consolidation range. Recommendation: Buy."},
    "WIPRO":    {"name":"Wipro","price":548,"chg":-0.4,"pe":22.1,"pb":3.4,"mktcap":"₹2.8L Cr","div":0.5,"roe":14.2,"sentiment":"Neutral","score":49,
                 "ai":"Wipro remains range-bound as deal ramp-ups take time to reflect in revenue. The new CEO's restructuring plan is in early stages. Monitor Q1 results for direction. Recommendation: Neutral."},
}
...
if symbol or search:
    ...
    if sym in STOCKS:
        ...
        <div style='display:flex;align-items:center;gap:16px;margin:20px 0 8px;'>
          <div>
            <div style='font-size:1.4rem;font-weight:700;color:#e2e8f0;'>{sym} <span style='font-size:0.9rem;font-weight:400;color:#64748b;'>· {s['name']}</span></div>
            <div style='font-size:2rem;font-weight:700;color:#e2e8f0;font-family:"JetBrains Mono",monospace;'>₹{s['price']:,} <span style='font-size:1rem;color:{"#34d399" if s["chg"]>0 else "#f87171"};'>{'+' if s['chg']>0 else ''}{s['chg']}%</span></div>
          </div>
          <div style='margin-left:auto;background:rgba({"52,211,153" if s["sentiment"]=="Bullish" else "248,113,113" if s["sentiment"]=="Bearish" else "100,116,139"},0.15);color:{"#34d399" if s["sentiment"]=="Bullish" else "#f87171" if s["sentiment"]=="Bearish" else "#94a3b8"};padding:6px 16px;border-radius:999px;font-weight:600;font-size:0.8rem;'>{s['sentiment']} · {s['score']}%</div>
        </div>
        """, unsafe_allow_html=True)
